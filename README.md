...
v3dBLAS uses, [V3DLib](https://github.com/wimrijnders/V3DLib) to program the [Broadcom Videocore VI](https://www.cpu-monkey.com/en/igpu-broadcom_videocore_vi) GPU in the [BCM2711](https://datasheets.raspberrypi.com/bcm2711/bcm2711-peripherals.pdf) SoC of the [Raspberry Pi 4](https://www.raspberrypi.com/products/raspberry-pi-4-model-b/) single board computer.
